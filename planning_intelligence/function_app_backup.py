    ...
    for r in records:
        if isinstance(r, dict):
            ...
            norm = {
                ...
                "scheduleChanged": r.get("scheduleChanged") or r.get("roj_changed") or r.get("rojChanged") or False,
...
@app.route(route="planning-intelligence", methods=["POST", "OPTIONS"])
...
@app.route(route="reasoning-query", methods=["POST", "OPTIONS"])
